...
def model_making(model_name, vect , model , X_train , y_train , X_test , y_test,name,results,training_time,prediction_time):
...
#va = raw_input()
	...
	#model7 = linear_model.SGDClasifier()
	#model_making("Random Forest",vect, model3, X_train, y_train, X_test, y_test)
	model_making("SVM" , vect, model4, X_train, y_train, X_test, y_test,name,results,training_time,prediction_time)
