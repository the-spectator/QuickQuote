...
class TestRegEx(unittest.TestCase):
	...
	def test_age(self):			
		...
		#self.assertEqual(ageRegex("f/40"), "40")
	...
	def test_height(self):
		self.assertEqual(heightRegex("Preferred Height and weight"), "5 Feet 9 Inches")
                #self.assertEqual(heightRegex("5'6''"), "5'6''")
                #self.assertEqual(heightRegex("5' 6''"), "5' 6''")
                #self.assertEqual(heightRegex("5'6'' 170lbs"), "6 Feet 4 Inch")
                #self.assertEqual(heightRegex("6'6'', 170lbs"), "6 Feet 4 Inch")
                #self.assertEqual(heightRegex("5 feet 6 inch"), "5 Feet 6 Inch")
                #self.assertEqual(heightRegex("5 Feet, 6 Inches"), "5 Feet 6 Inches")
                #self.assertEqual(heightRegex("ht: 5'6''"), "5 Feet 6 Inches")
                #self.assertEqual(heightRegex("height: 5 feet, 6 inches"), "5 Feet 6 Inches")
                #self.assertEqual(heightRegex("current height / weight - 5' 6'' / 150lbs"), "5 Feet 6 Inches")
                #self.assertEqual(heightRegex("Male DOB 11/07/1964 5'6'' 150 pounfs Nonsmoker"), "5 Feet 6 Inch")
                #self.assertEqual(heightRegex("F/age 50, NS, build 5.6.150"), "5 Feet 6 Inches")
                
                #self.assertEqual(changeHeight("5 Feet 6 Inch"), "5.6")
	...
	def test_weight(self):			
		self.assertEqual(weightRegex("Preferred Height and weight"), "196 lbs")
                ...
                #self.assertEqual(weightRegex("Weight: 150 Pounds"), "150 lb")
                #self.assertEqual(weightRegex("weight: 150 pounds"), "150 lb")
		#self.assertEqual(weightRegex("Male DOB 11/07/1964 5'6'' 150 pounds Nonsmoker"), "150lb")
	...
	def test_product_type(self):			
		...
		#self.assertEqual(productRegex("$100,000 ul"), "Product Type: Perm")
		...
		#self.assertEqual(faceamountRegex("we are looking for $2.5 mill of term coverage"), "Product Type: Term")
	...
	def test_face_amount(self):			
                #self.assertEqual(faceamountRegex("Face Amount: 50,000"), "Face Amount: 50,000")
                self.assertEqual(faceamountRegex("Face Amount: $500,212"), "Face Amount: $500,212")
                #self.assertEqual(faceamountRegex("amount: 150k to 200k"), "Face Amount: $200,00")
                ...
                #self.assertEqual(faceamountRegex("$100,000 ul"), "Face Amount: $1,00,000")
                self.assertEqual(faceamountRegex("term $1mm"), "Face Amount: 1,000,000")
                #self.assertEqual(faceamountRegex("50k term & 1000k ul"), "Face Amount: 1000,000")
                #self.assertEqual(faceamountRegex("500,000ul"), "Face Amount: 5000,000")
